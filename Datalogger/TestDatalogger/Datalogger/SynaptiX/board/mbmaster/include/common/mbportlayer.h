 ...
 */
typedef BOOL ( *pbMBPSerialTransmitterEmptyAPIV2CB )( xMBHandle xHdl, UBYTE *pubBufferOut, USHORT usBufferMax,
 ...
 */
eMBErrorCode
eMBPTCPClientInit( xMBPTCPHandle *pxTCPHdl, xMBHandle xMBHdl, peMBPTCPClientNewDataCB eMBPTCPClientNewDATAFN,
 ...
 */
eMBErrorCode
eMBPTCPServerInit( xMBPTCPHandle *pxTCPHdl, CHAR *pcBindAddress, USHORT usTCPPort, xMBHandle xMBHdl,
 ...
 */
eMBErrorCode
eMBPTCPConRead( xMBPTCPHandle xTCPHdl, xMBPTCPClientHandle xTCPClientHdl, UBYTE *pubBuffer, USHORT *pusBufferLen,
                USHORT usBufferMax );
 ...
 */
eMBErrorCode
eMBPUDPClientInit( xMBPUDPHandle *pxUDPHdl, xMBHandle xMBHdl, const CHAR *pcUDPBindAddress, LONG uUDPListenPort,
...
#if defined( DOXYGEN ) || ( defined( MBP_HAS_TIMESTAMP ) && ( MBP_HAS_TIMESTAMP == 1 ) )
