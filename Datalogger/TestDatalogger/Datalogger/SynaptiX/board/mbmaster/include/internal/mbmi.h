...
typedef struct
{
    void *xSer_Hdl;
    void *xTmr_Hdl;
    void *xTmr_RespTimeoutHdl;
#if (MBM_RTU_WAITAFTERSEND_ENABLED == 1) ||  (MBM_ASCII_WAITAFTERSEND_ENABLED == 1)
    void *xTmr_WaitHdl;
#endif
 ...
 */
void
vMBMMasterTransactionPolled( xMBMInternalHandle *pxIntHdl, UCHAR ucSlaveAddress,
