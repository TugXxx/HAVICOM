...
C_SRCS += \
../SynaptiX/board/nanomodbus/port/master_port.c 

OBJS += \
./SynaptiX/board/nanomodbus/port/master_port.o 

C_DEPS += \
./SynaptiX/board/nanomodbus/port/master_port.d 


# Each subdirectory must supply rules for building sources it contributes
SynaptiX/board/nanomodbus/port/%.o SynaptiX/board/nanomodbus/port/%.su SynaptiX/board/nanomodbus/port/%.cyclo: ../SynaptiX/board/nanomodbus/port/%.c SynaptiX/board/nanomodbus/port/subdir.mk
...
clean: clean-SynaptiX-2f-board-2f-nanomodbus-2f-port

clean-SynaptiX-2f-board-2f-nanomodbus-2f-port:
	-$(RM) ./SynaptiX/board/nanomodbus/port/master_port.cyclo ./SynaptiX/board/nanomodbus/port/master_port.d ./SynaptiX/board/nanomodbus/port/master_port.o ./SynaptiX/board/nanomodbus/port/master_port.su

.PHONY: clean-SynaptiX-2f-board-2f-nanomodbus-2f-port
